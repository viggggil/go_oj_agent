...
type AuthProto struct {
	...
	// Deprecated: Marked as deprecated in services/user/internal/conf/conf.proto.
	...
	AccessTokenPrivateKeyFile string         `protobuf:"bytes,7,opt,name=access_token_private_key_file,json=accessTokenPrivateKeyFile,proto3" json:"access_token_private_key_file,omitempty"`
	AccessTokenKeyId          string         `protobuf:"bytes,8,opt,name=access_token_key_id,json=accessTokenKeyId,proto3" json:"access_token_key_id,omitempty"`
...
func (x *AuthProto) GetAccessTokenPrivateKeyFile() string {
	if x != nil {
		return x.AccessTokenPrivateKeyFile
	}
	return ""
}
...
const file_services_user_internal_conf_conf_proto_rawDesc = "" +
	...
	"\x0fredis_namespace\x18\x05 \x01(\tR\x0eredisNamespace\"\xea\x02\n" +
	"\tAuthProto\x12(\n" +
	"\x10access_token_ttl\x18\x01 \x01(\tR\x0eaccessTokenTtl\x12*\n" +
	"\x11refresh_token_ttl\x18\x02 \x01(\tR\x0frefreshTokenTtl\x12,\n" +
	"\x10access_token_key\x18\x03 \x01(\tB\x02\x18\x01R\x0eaccessTokenKey\x12@\n" +
	"\x1daccess_token_private_key_file\x18\a \x01(\tR\x19accessTokenPrivateKeyFile\x12-\n" +
	"\x13access_token_key_id\x18\b \x01(\tR\x10accessTokenKeyId\x12\x16\n" +
